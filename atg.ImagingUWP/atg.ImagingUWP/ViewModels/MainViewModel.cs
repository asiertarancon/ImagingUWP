using atg.ImagingUWP.Effects;
using atg.ImagingUWP.Utilities;
...
namespace atg.ImagingUWP.ViewModels
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public ImageSource CameraImageSource
        {
            ...
            set { Set(ref m_cameraImageSource, value); }
        }

        public string CameraSettings
        {
            get { return m_cameraSettings; }
            set { Set(ref m_cameraSettings, value); }
        }
        ...
        public string CurrentState
        {
            ...
            set { Set(ref m_currentState, value); }
        }
        ...
        public VideoEffectsViewModel CurrentStaticEditor
        {
            ...
            set
            {
                Set(ref m_currentStaticEditor, value);
                UpdateConfiguration();
            }
        }
        ...
        public bool IsStaticEffectVisible
        {
            ...
            set
            {
                ...
                IsEditing = false;
                Set(ref m_isStaticEffectVisible, value);
        ...
        private void UpdateButtonState()
        {
            ...
            StartStopRecordCommand.RaiseCanExecuteChanged();
            ToggleCameraCommand.RaiseCanExecuteChanged();
        }
